...
static void getFtrVal(double samplesFtrVal[],double*iH,double *sx,double * sy,double *px, double *py, double *pw,
					  double *ph, double *pwt, int len_F,int len_S,int len_R,int M,int N,double *probe)
...
{ 
	double *iH,*sx,*sy,*px,*py,*pw,*ph,*pwt,*probe; 
	...
	getFtrVal(samplesFtrVal,iH,sx,sy,px,py,pw,ph,pwt,len_F,len_S,len_R,M,N,probe);
